...
class MyPanel(wx.Panel):
	...
	def OnClick(self, event):
		global attack, ActiveMoves, ActivePiece, moves
		...
		for o in range(100000):
			...
			PosDict = {0:11,
						...
						62:87,
						63:88}
			Status_PressedA = PosDict[Pos]
			player = 1
			Piece = Board().GetPosition(Status_PressedA)
			Status_Pressed = str(PosDict[Pos])
