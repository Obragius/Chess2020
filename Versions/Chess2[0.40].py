					...
					while Moves < len(ActiveMoves):
						...
						if Stop == 1:
							...
							if Piece[1] == "K":
								print('it is K')
								if player == 1:
									if Board().BoardConfig[7][1] == "WK":
										Board().BoardConfig[7][2] = "WR"
										Board().BoardConfig[7][0] = "  "
										self.button[7][2].SetBitmap(ImageToLoad[ImageToLoadDict["WR"]][GreyAttribute[7][2]])
									...
									if Board().BoardConfig[0][1] == "BK":
										Board().BoardConfig[0][2] = "BR"
										Board().BoardConfig[0][0] = "  "
										self.button[0][2].SetBitmap(ImageToLoad[ImageToLoadDict["BR"]][GreyAttribute[0][2]])
