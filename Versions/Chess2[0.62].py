...
class LoadingImages():
	def initilize(self):
		...
		imageFileGreen = "C:\\Users\\lolki\\Desktop\\Python\\Chess 2.0\\Images\\Green.png"

		imageGreen = wx.Image(imageFileGreen, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		...
		imageBlack_King_Green = wx.Image(imageFileBlack_King_Green, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		imageBlack_Queen_Green = wx.Image(imageFileBlack_Queen_Green, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		imageBlack_Bishop_Green = wx.Image(imageFileBlack_Bishop_Green, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		imageBlack_Rook_Green = wx.Image(imageFileBlack_Rook_Green, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		imageBlack_Knight_Green = wx.Image(imageFileBlack_Knight_Green, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		imageBlack_Pawn_Green = wx.Image(imageFileBlack_Pawn_Green, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		imageWhite_King_Green = wx.Image(imageFileWhite_King_Green, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		imageWhite_Queen_Green = wx.Image(imageFileWhite_Queen_Green, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		imageWhite_Bishop_Green = wx.Image(imageFileWhite_Bishop_Green, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		imageWhite_Rook_Green = wx.Image(imageFileWhite_Rook_Green, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		imageWhite_Knight_Green = wx.Image(imageFileWhite_Knight_Green, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		imageWhite_Pawn_Green = wx.Image(imageFileWhite_Pawn_Green, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
	...
	def __init__(self, parent):
		...
		for i in range(8):
			...
			for j in range(8):
				...
				self.button[i][j] = wx.BitmapButton(self, id =int(str(i+1)+str(j+1)), bitmap = ImageToLoad[ImageID][GreyAttribute[i][j]], size = (100,100))
					...
					for i in range(8):
						for j in range(8):
							...
							if len(Piece) > 2:
								...
								print(ImageID)
								self.button[i][j].SetBitmap(ImageToLoadGreen[ImageID])
