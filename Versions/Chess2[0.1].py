...
class MyPanel(wx.Panel):
	...
	def __init__(self, parent):
		...
		imageFileBlack_King = "C:\\Users\\lolki\\Desktop\\Python\\Chess 2.0\\Images\\Black_King_1"
		imageFileBlack_Queen = "C:\\Users\\lolki\\Desktop\\Python\\Chess 2.0\\Images\\Black_Queen_1.png"
		imageFileBlack_Bishop = "C:\\Users\\lolki\\Desktop\\Python\\Chess 2.0\\Images\\Black_Bishop_1.ong"
		...
		imageFileWhite_King = "C:\\Users\\lolki\\Desktop\\Python\\Chess 2.0\\Images\\White_King_1"
		imageFileWhite_Queen = "C:\\Users\\lolki\\Desktop\\Python\\Chess 2.0\\Images\\White_Queen_1.png"
		imageFileWhite_Bishop = "C:\\Users\\lolki\\Desktop\\Python\\Chess 2.0\\Images\\White_Bishop_1.ong"
		...
		image1 = wx.Image(imageFileWhite, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
		image2 = wx.Image(imageFileBlack, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
			...
			for j in range(8):
				if (i % 2) == 0:
					if (j % 2) == 0:
						...
						self.button[i][j] = wx.BitmapButton(self, id =int(str(i+1)+str(j+1)), bitmap = image1, size = (100,100))
						hbox[i].Add(self.button[i][j], 0 , wx.ALIGN_CENTER)
					else:
						self.button[i].append([])
						self.button[i][j] = wx.BitmapButton(self, id =int(str(i+1)+str(j+1)), bitmap = image2, size = (100,100))
						hbox[i].Add(self.button[i][j], 0 , wx.ALIGN_CENTER)
				else:
					if (j % 2) == 0:
						self.button[i].append([])
